...
public class BananaScript : MonoBehaviour
{
    ...
    public void AddItemToBackpack()
    {
        ...
        if (costPrice <= shopManager.MoneyAvail && backpackManager.CanAddItem(weightMass))
        {
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                {
                    BananaScript existingItemScript = slotChild.GetChild(0).GetComponent<BananaScript>();
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                if (slotChild.childCount == 0)
                {
                    ...
                    BananaScript itemScript = instantiatedItem.GetComponent<BananaScript>();
    ...
    public void ChestToBackpackAndViceVersa()
    {
        ...
        if (isBackpackSlot)
        {
            BananaScript itemScript = GetComponent<BananaScript>();
            ...
            for (int i = 0; i < chestSlotParent.childCount; i++)
            {
                ...
                {
                    BananaScript existingItemScript = chestSlotChild.GetChild(0).GetComponent<BananaScript>();
        ...
        else if (isChestSlot)
        {
            ...
            for (int i = 0; i < backpackSlotParent.childCount; i++)
            {
                ...
                {
                    BananaScript existingItemScript = backpackSlotChild.GetChild(0).GetComponent<BananaScript>();
