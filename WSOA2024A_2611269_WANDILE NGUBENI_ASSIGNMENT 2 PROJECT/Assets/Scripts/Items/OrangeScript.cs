...
public class OrangeScript: MonoBehaviour
{
    ...
    public void AddItemToBackpack()
    {
        ...
        if (costPrice <= shopManager.MoneyAvail && backpackManager.CanAddItem(weightMass))
        {
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                {
                    OrangeScript existingItemScript = slotChild.GetChild(0).GetComponent<OrangeScript>();
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                if (slotChild.childCount == 0)
                {
                    ...
                    OrangeScript itemScript = instantiatedItem.GetComponent<OrangeScript>();
    ...
    public void ChestToBackpackAndViceVersa()
    {
        ...
        if (isBackpackSlot)
        {
            OrangeScript itemScript = GetComponent<OrangeScript>();
            ...
            for (int i = 0; i < chestSlotParent.childCount; i++)
            {
                ...
                {
                    OrangeScript existingItemScript = chestSlotChild.GetChild(0).GetComponent<OrangeScript>();
        ...
        else if (isChestSlot)
        {
            ...
            for (int i = 0; i < backpackSlotParent.childCount; i++)
            {
                ...
                {
                    OrangeScript existingItemScript = backpackSlotChild.GetChild(0).GetComponent<OrangeScript>();
