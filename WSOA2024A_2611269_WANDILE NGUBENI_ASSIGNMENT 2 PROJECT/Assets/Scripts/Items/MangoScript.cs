...
public class MangoScript: MonoBehaviour
{
    ...
    public int costPrice = 19;
    public TMP_Text weightText;
    public int weightMass = 8;
    ...
    public void AddItemToBackpack()
    {
        ...
        if (costPrice <= shopManager.MoneyAvail && backpackManager.CanAddItem(weightMass))
        {
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                {
                    MangoScript existingItemScript = slotChild.GetChild(0).GetComponent<MangoScript>();
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                if (slotChild.childCount == 0)
                {
                    ...
                    MangoScript itemScript = instantiatedItem.GetComponent<MangoScript>();
    ...
    public void ChestToBackpackAndViceVersa()
    {
        ...
        if (isBackpackSlot)
        {
            MangoScript itemScript = GetComponent<MangoScript>();
            ...
            for (int i = 0; i < chestSlotParent.childCount; i++)
            {
                ...
                {
                    MangoScript existingItemScript = chestSlotChild.GetChild(0).GetComponent<MangoScript>();
        ...
        else if (isChestSlot)
        {
            ...
            for (int i = 0; i < backpackSlotParent.childCount; i++)
            {
                ...
                {
                    MangoScript existingItemScript = backpackSlotChild.GetChild(0).GetComponent<MangoScript>();
