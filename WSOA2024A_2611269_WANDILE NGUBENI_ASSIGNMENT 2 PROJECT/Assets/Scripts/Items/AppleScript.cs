...
public class AppleScript : MonoBehaviour
{
    ...
    public int Amount = 0;
    //this bool checks to see if the item has already been instantiated
    ...
    public void AddItemToBackpack()
    {
        ...
        if (costPrice <= shopManager.MoneyAvail && backpackManager.CanAddItem(weightMass))
        {
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                {
                    AppleScript existingItemScript = slotChild.GetChild(0).GetComponent<AppleScript>();
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                if (slotChild.childCount == 0)
                {
                    ...
                    AppleScript itemScript = instantiatedItem.GetComponent<AppleScript>();
    ...
    public void ChestToBackpackAndViceVersa()
    {
        ...
        if (isBackpackSlot)
        {
            AppleScript itemScript = GetComponent<AppleScript>();
            ...
            for (int i = 0; i < chestSlotParent.childCount; i++)
            {
                ...
                {
                    AppleScript existingItemScript = chestSlotChild.GetChild(0).GetComponent<AppleScript>();
        ...
        else if (isChestSlot)
        {
            ...
            for (int i = 0; i < backpackSlotParent.childCount; i++)
            {
                ...
                {
                    AppleScript existingItemScript = backpackSlotChild.GetChild(0).GetComponent<AppleScript>();
