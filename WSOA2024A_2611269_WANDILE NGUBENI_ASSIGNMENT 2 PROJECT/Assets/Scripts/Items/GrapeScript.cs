...
public class GrapeScript : MonoBehaviour
{
    ...
    public void AddItemToBackpack()
    {
        ...
        if (costPrice <= shopManager.MoneyAvail && backpackManager.CanAddItem(weightMass))
        {
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                {
                    GrapeScript existingItemScript = slotChild.GetChild(0).GetComponent<GrapeScript>();
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                if (slotChild.childCount == 0)
                {
                    ...
                    GrapeScript itemScript = instantiatedItem.GetComponent<GrapeScript>();
    ...
    public void ChestToBackpackAndViceVersa()
    {
        ...
        if (isBackpackSlot)
        {
            GrapeScript itemScript = GetComponent<GrapeScript>();
            ...
            for (int i = 0; i < chestSlotParent.childCount; i++)
            {
                ...
                {
                    GrapeScript existingItemScript = chestSlotChild.GetChild(0).GetComponent<GrapeScript>();
        ...
        else if (isChestSlot)
        {
            ...
            for (int i = 0; i < backpackSlotParent.childCount; i++)
            {
                ...
                {
                    GrapeScript existingItemScript = backpackSlotChild.GetChild(0).GetComponent<GrapeScript>();
