...
public class PearScript : MonoBehaviour
{
    ...
    public void AddItemToBackpack()
    {
        ...
        if (costPrice <= shopManager.MoneyAvail && backpackManager.CanAddItem(weightMass))
        {
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                {
                    PearScript existingItemScript = slotChild.GetChild(0).GetComponent<PearScript>();
            ...
            for (int i = 0; i < slotParent.childCount; i++)
            {
                ...
                if (slotChild.childCount == 0)
                {
                    ...
                    PearScript itemScript = instantiatedItem.GetComponent<PearScript>();
    ...
    public void ChestToBackpackAndViceVersa()
    {
        ...
        if (isBackpackSlot)
        {
            PearScript itemScript = GetComponent<PearScript>();
            ...
            for (int i = 0; i < chestSlotParent.childCount; i++)
            {
                ...
                {
                    PearScript existingItemScript = chestSlotChild.GetChild(0).GetComponent<PearScript>();
        ...
        else if (isChestSlot)
        {
            ...
            for (int i = 0; i < backpackSlotParent.childCount; i++)
            {
                ...
                {
                    PearScript existingItemScript = backpackSlotChild.GetChild(0).GetComponent<PearScript>();
